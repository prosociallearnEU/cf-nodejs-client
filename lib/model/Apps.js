 ...
 * @param {String} _API_URL [cloud controller api url]
 * @constructor
 */
...
/**
 * Set address to define cloud controller api url
 * 
 * @param {String} _API_URL [cloud controller api url]
 */
Apps.prototype.setEndPoint = function (_API_URL) {
    this.API_URL = _API_URL;
};
 ...
 * @return {JSON}              [return a JSON Object with application data]
 */
