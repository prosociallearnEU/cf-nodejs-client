...
Apps.prototype.uploadApp = function(token_type,access_token,app_guid,dataRemoteFile,resourceMatched){
    ...
    return new Promise(function (resolve, reject) {
        request.put({ url: url, headers: headers, qs: qs, form: body }, function (error, response, body) {
 ...
 */
Apps.prototype.uploadApp2 = function (token_type,access_token,appGuid,dataRemoteFile,zipName,resourceMatched, callback) {
