...
class UsersUAA {
     ...
     */
    add (tokenType, accessToken, uaaOptions) {
     ...
     * @return {JSON}              [return a JSON response]
     */
    updatePassword (tokenType, accessToken, uaaGuid, uaaOptions) {
     ...
     * @return {JSON}              [return a JSON response]
     */
    remove (tokenType, accessToken, uaaGuid) {
     ...
     * @return {JSON}              [return a JSON response]
     */
    getUsers (tokenType, accessToken, searchOptions) {
