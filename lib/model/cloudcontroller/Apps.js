 ...
 */
Apps.prototype.downloadBits = function (token_type, access_token, app_guid) {

    var url = this.API_URL + "/v2/apps/" + app_guid + "/download";
    var options = {
        method: "GET",
        url: url,
        headers: {
 ...
 * @return {[type]}              [description]
 */
Apps.prototype.downloadDroplet = function (token_type, access_token, app_guid) {

    var url = this.API_URL + "/v2/apps/" + app_guid + "/droplet/download";
    var options = {
        method: "GET",
        url: url,
        headers: {
