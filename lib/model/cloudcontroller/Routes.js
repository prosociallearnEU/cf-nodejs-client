...
class Routes extends CloudControllerBase {
     ...
     *
     * @param  {String} domain_guid     [domain guid]
     * @param  {String} host            [hostname]
     * @return {String}                 [output]
     */
     exists (domain_guid, hostname) {
        const url = `${this.API_URL}/routes/reserved/domain/${domain_guid}/host/${hostname}?path=/apps/v1/path`;
        const options = {
            method: "GET",
            url: url,
            headers: {
