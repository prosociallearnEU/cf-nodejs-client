...
class Users extends CloudControllerBase {
     ...
     */
    add (token_type, access_token, userOptions) {
     ...
     * @return {JSON}              [return a JSON response]
     */
    remove (token_type, access_token, user_guid) {
     ...
     * @return {JSON}                [return a JSON response]
     */
    getUsers (token_type, access_token) {
     ...
     * @return {JSON}                [return a JSON response]
     */
    associateSpace (token_type, access_token, user_guid, space_guid) {
     ...
     * @return {JSON}                [return a JSON response]
     */
    associateOrganization (token_type, access_token, user_guid, org_guid) {
