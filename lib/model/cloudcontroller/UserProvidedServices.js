...
class UserProvidedServices extends CloudControllerBase {
     ...
     */
    getServices (token_type, access_token) {
     ...
     * @return {JSON}              [return a JSON response]
     */
    getService (token_type, access_token, service_guid) {

        const url = this.API_URL + "/v2/user_provided_service_instances/" + service_guid;
        const options = {
            method: "GET",
            url: url,
            headers: {
     ...
     * @return {JSON}              [return a JSON response]
     */
    add (token_type, access_token, user_provided_service_options) {
     ...
     * @return {JSON}              [Output]
     */
    getServiceBindings (token_type, access_token, service_guid, filter) {

        const url = this.API_URL + "/v2/user_provided_service_instances/" + service_guid + "/service_bindings";
        let qs = {};
